...
export function buildRegistrySystemPrompt(settings, options = {}) {
  ...
  const prompt = [
    ...
    '示例：',
    '- 初入职场的新人: {"experience":{"virginity":"前男友","emotionalMate":"{{user_name}}","pregnantExperience":0}}',
    '- 风尘女子: {"experience":{"virginity":"客人","emotionalMate":null,"pregnantExperience":5,"naturalBirthExperience":3,"surgicalBirthExperience":0,"miscarriageExperience":2}}',
